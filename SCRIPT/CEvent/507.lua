--OEVENTLUA[507] = function()		--射雕中邪杀一灯
    ...
    if instruct_5(0,254) ==true then    --  5(5):是否选择战斗？否则跳转到:Label0
		...
		SetS(19,41,31,3,32)
		SetS(19,42,31,3,33)
		instruct_3(19,25,1,0,0,0,0,8002,8002,8002,-2,-2,-2);   --  3(3):修改事件定义:场景[重阳宫]:场景事件编号 [25]
		instruct_3(19,31,1,0,0,0,0,8004,8004,8004,-2,-2,-2);   --  3(3):修改事件定义:场景[重阳宫]:场景事件编号 [31]
